...
class Car:
    ...
    def application_creation(self):
        return Seq([
            ...
            App.globalPut(self.Variables.approved, Int(0)),
  ...
  # buy car
    def buy(self):
        ...
        valid_payment_to_seller = And(
            ...
            App.globalGet(self.Variables.approved) != Int(0)
        )
  ...
  # add more car to the listing
    ...
    def approve(self):
        ...
        return Seq([
            App.globalPut(self.Variables.approved,
                          Int(1)),
            Approve()
        ])
    ...
    def application_start(self):
        return Cond(
            ...
            [Txn.application_args[0] ==
                self.AppMethods.changelocation, self.changelocation()],
            [Txn.application_args[0] ==
                self.AppMethods.approve, self.approve()],
        )
